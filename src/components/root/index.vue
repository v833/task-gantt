    ...
    >
      ...
      <GanttHeader>
        <template #mile-stone="{ data }">
          <slot name="mile-stone" :data="data"></slot>
        </template>
      </GanttHeader>

      <!-- 甘特内容 -->
      <GanttBody />
      <GanttFooter v-if="props.showFooter" />
    </sync-scroll-container>
  </div>
</template>
...
import GanttFooter from '@/components/container/GanttFooter.vue';
